...
class Pages_lock_screen extends Component
{
	 ...
	 <div className="accountbg"></div>
        <div className="wrapper-page">
            ...
            <div className="m-t-40 text-center">
                <p className="text-white">Not you ? return <Link to="pages_login" className="font-500 font-14 text-white font-secondary"> Sign In </Link> </p>
...
export default connect(mapStatetoProps, mapDispatchtoProps)(Pages_lock_screen);

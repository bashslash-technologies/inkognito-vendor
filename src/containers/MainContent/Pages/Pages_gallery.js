...
class Pages_gallery extends Component{
                            ...
                            <div className="project-item">
                                <div className="overlay-container">
                                    ...
                                    <div className="project-item-overlay">
                                        ...
                                        <p>
                                            <img src="assets/images/users/avatar-1.jpg" alt="user" className="thumb-sm rounded-circle" />
                            ...
                            <div className="project-item">
                                <div className="overlay-container">
                                    ...
                                    <div className="project-item-overlay">
                                        ...
                                        <p>
                                            <img src="assets/images/users/avatar-2.jpg" alt="user" className="thumb-sm rounded-circle" />
                                            <span className="ml-2">Curtis Marion</span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="project-item">
                                <div className="overlay-container">
                                    ...
                                    <div className="project-item-overlay">
                                        ...
                                        <p>
                                            <img src="assets/images/users/avatar-3.jpg" alt="user" className="thumb-sm rounded-circle" />
                                            <span className="ml-2">Curtis Marion</span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="project-item">
                                <div className="overlay-container">
                                    ...
                                    <div className="project-item-overlay">
                                        <h4>Morning Dew</h4>
                                        <p>
                                            <img src="assets/images/users/avatar-4.jpg" alt="user" className="thumb-sm rounded-circle" />
                                            <span className="ml-2">Curtis Marion</span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="project-item">
                                <div className="overlay-container">
                                    ...
                                    <div className="project-item-overlay">
                                        ...
                                        <p>
                                            <img src="assets/images/users/avatar-5.jpg" alt="user" className="thumb-sm rounded-circle" />
                                            <span className="ml-2">Curtis Marion</span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="project-item">
                                <div className="overlay-container">
                                    ...
                                    <div className="project-item-overlay">
                                        <h4>Shake It!</h4>
                                        <p>
                                            <img src="assets/images/users/avatar-6.jpg" alt="user" className="thumb-sm rounded-circle" />
                                            <span className="ml-2">Curtis Marion</span>
                                        </p>
                                    </div>
                                </div>

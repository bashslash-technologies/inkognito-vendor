                    ...
                    <div className="col-12">
                        <div className="card m-b-20">
                            <div className="card-body">
                                ...
                                <p className="text-muted m-b-30 font-14">DataTables has most features enabled by
                    ...
                    <div className="col-12">
                        <div className="card m-b-20">
                            <div className="card-body">
                                ...
                                <p className="text-muted m-b-30 font-14">The Buttons extension for DataTables

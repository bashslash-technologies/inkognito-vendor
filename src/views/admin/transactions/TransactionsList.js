            ...
            <div className="row">
                <div className="col-md-6 col-lg-6 col-xl-4">
                    <div className="mini-stat clearfix bg-white">
                        ...
                        <p className=" mb-0 m-t-10 text-muted">Completed Transactions<span className="pull-right"><i className="fa fa-caret-down text-danger m-r-5"></i>3.25%</span></p>
                    </div>
                </div>
                <div className="col-md-6 col-lg-6 col-xl-4">
                    <div className="mini-stat clearfix bg-white">
                        ...
                        <div className="clearfix"></div>
                        <p className=" mb-0 m-t-10 text-muted">Active Transactions<span className="pull-right"><i className="fa fa-caret-up text-success m-r-5"></i>8.51%</span></p>
                    </div>
                </div>
                <div className="col-md-6 col-lg-6 col-xl-4">
                    <div className="mini-stat clearfix bg-white">
                        ...
                        <div className="clearfix"></div>
                        <p className=" mb-0 m-t-10 text-muted">Cancelled Transactions<span className="pull-right"><i className="fa fa-caret-down text-danger m-r-5"></i>5.52%</span></p>
                    </div>
                </div>
            </div>
